...
public class MergeSort {
    ...
    public static ArrayList merge(ArrayList<Float> left, ArrayList<Float> right) {
    ...
    public static ArrayList mergeSort(ArrayList<Float> list) {
        if (list.size() <= 1) {
            return list;
        }
...
//        final int SIZE = 10;
//        ArrayList<Float> inpArray = new ArrayList<Float>();
